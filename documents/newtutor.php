 <?php
    ...
    $firstName = "";$lastName = "";$dob = "";$email = "";$phone = "";$firstline = "";$secondline = "";$thirdline = "";$town = "";$region = "";$zip = "";
    ...
    if(isset($_POST["submit"])){
        ...
        if(Validator::check($firstNameError, $lastNameError, $emailError, $phoneError, $dobError, $firstlineError, $secondlineError, $thirdlineError, $townError, $regionError, $zipError)){
            ...
            $ccontact->contactFirstName = $firstName;
            $ccontact->contactLastName = $lastName;
            $date = new Date();
            $date->periodToDate($dob);
            $ccontact->contactDOB = $date->toDB();
            $ccontact->contactAddress = $address->convertToDB();
            $ccontact->contactEmail = $email;
            $ccontact->contactPhone = $phone;
            $ccontact->roleId = 3;
            $ccontact->clientId = $client->clientId;
            
            $ccontactId = $dao->add($ccontact);
            $tutor->clientId = $client->clientId;
            $tutor->contactId = $ccontactId;
            $tutor->tutorApprovedCourses = "";
            $tutor->tutorStatusId = 1;
            $tutorId = $dao->add($tutor);
            
            $user = new User;
            $user->clientId = $client->clientId;
            $user->contactId = $ccontactId;
            $dao->add($user);
                            ...
                            <div class="col5">
                                ...
                                <div class="settingsSubSection">
                                    ...
                                    <div class="input-group input-append date" id="datepicker1">
                                        <input type="text" class="form-control col6" name="dob" />
