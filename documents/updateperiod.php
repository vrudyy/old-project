<?php
    ...
    $period = $dao->get("Period", $_POST["periodid"], "periodId");
    
    $date = new Date();
    $periodTitle = $period->periodTitle;
    $periodStart = $date->longDate($period->periodStart);
    $periodEnd = $date->longDate($period->periodEnd);
        
    if(isset($_POST["delete"])){
        $dao->delete("Period", "periodId", $period->periodId);
        ob_start();
            ...
            <div class="content">
               <div class="settingswrapper">
                    <form id="detailsForm" action="" method="post">
                        ...
                        <input type="hidden" name="periodid" value="<?php echo $_POST["periodid"] ?>"/>
                        <button name="submit" value="submit" type="submit" class="widget left"><?php echo($dic->translate("Update Period")) ?></button>
                        <button id="resetButton"class="widget cwidget" type="reset" value="reset"><?php echo($dic->translate("Cancel")) ?></button>
                        <button name="delete" value="delete" type="submit" class="rwidget widget"><?php echo($dic->translate("Delete")) ?></button>
                    </form>
                </div>
