<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $roomNameError = Validator::isEmpty($roomName, "Room Name");
        $roomCapacityError = Validator::isEmpty($roomCapacity, "Room Capacity");
        $roomHourCostError = Validator::isEmpty($roomHourCost, "Hourly Cost");
        
        if(Validator::check($roomNameError,$roomCapacityError,$roomHourCostError)){
            $room = new Room();
            $room->roomId = $dao->next("Room", "roomId");
                ...
                <div class="settingswrapper">
                    <form id="detailsForm" action="" method="post">
                        <div class="in-row settingsSection vsec" style="border: none;">
                            <div class="col5">
                                <h3><?php echo($dic->translate("Room Details")) ?></h3>
                        ...
                        <button name="submit" value="submit" type="submit" class="widget left"><?php echo($dic->translate("Add Room")) ?></button>
