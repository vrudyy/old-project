    ...
    if(isset($_POST["save-sow"])){
     ...
     for($v = 1; $v<sizeof($sows)+1; $v++){
        $sow = $sows[$v-1];
        $_POST["pl".$v] = $sow->sowPlannedSyllabus;
        $_POST["d".$v] = $sow->sowWeekDate;
        $_POST["n".$v] = $sow->sowNotes;
        $_POST["ita".$v] = $sow->sowInovativeTeaching;
        $_POST["le".$v] = $sow->sowLesson;
        $_POST["fl".$v] = $sow->sowResources;
    }
...
<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="content">
                <form method="post" action="editschemeofwork.php#new">
                            ...
                            <div class="in-row in-sow-rows">
                                ...
                                ?>
                                            <div class="in-row in-sow-row">
                                                ...
                                                <div class="col3 in-txt"><textarea style="overflow: hidden;" name="pl<?PHP echo($j)?>"><?PHP echo($_POST["pl".$j])?></textarea></div>
