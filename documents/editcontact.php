 <?php
    ...
    $cc = $dao->get("Contact", $_POST["contactid"], "contactId");
    #$cc = new Contact();
    
    $firstName = $cc->contactFirstName;
    $lastName = $cc->contactLastName;
    $organisation = $cc->contactOrganisation;
    $email = $cc->contactEmail;
    $phone = $cc->contactPhone;
    
    $d = new Date();
    $d->fromInput($cc->contactDOB);
    $dob = $d->toString();
    
    
    
    $a = new Address();
    $a->convertToObject($cc->contactAddress);
    
    //gets the form data
    $firstline = $a->firstline;
    $secondline = $a->secondline;
    $thirdline = $a->thirdline;
    $town = $a->town;
    $region = $a->region;
    $zip = $a->zip;
    ...
    if(isset($_POST["submit"])){
        ...
        $regionError = "";
        $zipError = "";
        //$firstNameError, $lastNameError, $organisationError, 
        //if there are no input errors
        if((Validator::check($firstNameError, $lastNameError) || Validator::check($organisationError)) && Validator::check($dobError, $emailError, $phoneError, $firstlineError, $secondlineError, $thirdlineError, $townError, $regionError, $zipError)){
            ...
            <div class="content">
                <div class="settingswrapper">
                    <form id="detailsForm" action="" method="post">
                            ...
                            <div class="col5">
                                ...
                                <div class="settingsSubSection">
                                    ...
                                    <div class="input-group input-append date" id="datepicker1">
                                        <input value="<?php echo($dob)?>" type="text" class="form-control col6" name="dateOfBirth" />
                        ...
                        <input type="hidden" name="contactid" value="<?php echo $cc->contactId?>" />
