<?php
    ...
    $address = new Address();
    $address->convertToObject($branch->branchAddress);
                ...
                <div class="settingswrapper">
                    <form id="detailsForm" action="" method="post">
                        <div class="in-row settingsSection vsec" style="border: none;">
                            <div class="col5">
                                <h3><?php echo($dic->translate("Update Branch")) ?></h3>
                                <div class="settingsSubSection">
                                    <label class="col6"><?php echo($dic->translate("Branch Name")) ?> <span style="color:red;">*</span></label>
                                    <input value="<?php echo $branch->branchName ?>" class="col6" type="text" name="branchName">
                                ...
                                <div class="settingsSubSection">
                                    ...
                                    <input value="<?php echo $address->firstline ?>" class="col6" type="text" name="firstline">
                                    <p class="error"><?php echo $firstlineError ?></p>
                                </div>
                                <div class="settingsSubSection">
                                    <label class="col6"></label>
                                    <input value="<?php echo $address->secondline ?>" class="col6" type="text" name="secondline">
                                    <p class="error"><?php echo $secondlineError ?></p>
                                </div>
                                <div class="settingsSubSection">
                                    <label class="col6"></label>
                                    <input value="<?php echo $address->thirdline ?>" class="col6" type="text" name="thirdline">
                                    <p class="error"><?php echo $thirdlineError ?></p>
                                </div>
                                <div class="settingsSubSection">
                                    <label class="col6"><?php echo($dic->translate("Town")) ?> <span style="color:red;">*</span></label>
                                    <input value="<?php echo $address->town ?>" class="col6" type="text" name="town">
                                    <p class="error"><?php echo $townError ?></p>
                                </div>
                                <div class="settingsSubSection">
                                    <label class="col6"><?php echo($dic->translate("Region or State")) ?></label>
                                    <input value="<?php echo $address->region ?>" class="col6" type="text" name="region">
                                ...
                                <div class="settingsSubSection">
                                    ...
                                    <input value="<?php echo $address->zip ?>" class="col6" type="text" name="zip">
                                    <p class="error"><?php echo $zipError ?></p>
                                </div>
                                <div class="settingsSubSection">
                                    <label class="col6"><?php echo($dic->translate("Branch Phone")) ?> <span style="color:red;">*</span></label>
                                    <input value="<?php echo $branch->branchPhone ?>" class="col6" type="text" name="branchPhone">
                                ...
                                <div class="settingsSubSection">
                                    ...
                                    <select name="activate">
                                        <?php 
                                            echo "<option ".(($branch->branchActive == 1) ? "selected" : "")." value=\"1\">".$dic->translate("Active")."</option>";
                                            echo "<option ".(($branch->branchActive == 0) ? "selected" : "")." value=\"0\">".$dic->translate("Not Active")."</option>";
                                        ?>
                                    </select>
                        ...
                        <button name="submit" value="submit" type="submit" class="widget left"><?php echo($dic->translate("Save")) ?></button>
